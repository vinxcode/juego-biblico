  ...
  return (
    <div className='flex flex-col font-tilt'>
      ...
      <div className='flex flex-col justify-center items-center'>
        <section className='mx-auto w-[1200px] mt-10 grid grid-cols-8 gap-5 relative'>
          {
            ...
            ${estadosPreguntas[index].hover} cursor-pointer shadow-lg  solid border-white border-8`}
              >
                <p className='text-center font-black text-7xl text-white h-[70px]'>{estadosPreguntas[index].contenido === "" ? pregunta.idPregunta : "X"}</p>
